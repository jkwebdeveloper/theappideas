...
const SalonApp = () => {
  ...
  const SalonData = [
    ...
    },
    {
      ...
      des:
        'he calendar is also integrated into a customer app to conveniently manage the appointment. Customers can check the calendar and book appointments accordingly.',
    },
    {
      id: 6,
      category: 'customer_app',
