...
// Banner
import Development from '../../../assets/images/SOLUTIONS/On-Demand App/Taxi Booking App Solution/Taxi-Booking-App-Development.png'
import Services from '../../../assets/images/SOLUTIONS/On-Demand App/Taxi Booking App Solution/Build-Taxi-App.png'
import developer from '../../../assets/images/SOLUTIONS/On-Demand App/Taxi Booking App Solution/Taxi-Booking-App-Development-Company.png'
...
const TaxiBooking = () => {
  ...
  const TaxiBookingData = [
    ...
    },
    {
      ...
      des:
        'Users need to choose their preferred drop-off location or destination on the GPS map.',
    },
    {
      id: 4,
      category: 'passenger_app',
      ...
      title: 'Booking Types',
      des:
        'Users need to choose one booking type from all the available types of booking.',
    },
    {
      id: 5,
      category: 'passenger_app',
    ...
    },
    {
      ...
      des:
        'Users can pay their fare online by using any of the available payment methods.',
    },
    {
      id: 7,
      category: 'passenger_app',
      ...
      des:
        'Users can give rating to the driver and the app and post reviews on the basis of their feedback.',
    },
    {
      id: 8,
      category: 'passenger_app',
      ...
      title: 'Order History',
      des:
        'Users can access their order history to have a detailed look at the rides availed by them through the app.',
    },
    {
      id: 9,
      category: 'passenger_app',
      ...
      title: 'Avail Offers',
      des:
        'Users can avail various promotional offers and discount coupons that from time to time are sent through notifications.',
    },
    {
      id: 10,
      category: 'passenger_app',
    ...
    },
    {
      ...
      des:
        'Driver can select his visibility area and can make him available unavailable.',
    },
    {
      id: 12,
      category: 'on_demand_driver_app',
      ...
      des:
        'Driver can spot the nearby drivers on the map and can chat with them.',
    },
    {
      id: 13,
      category: 'on_demand_driver_app',
      ...
      des:
        'The driver app also helps finding all the available drivers nearby.',
    },
    {
      id: 14,
      category: 'on_demand_driver_app',
      ...
      des:
        'The driver app also shows on the GPS map the various on-road scenarios when the vehicle approaches.',
    },
    {
      id: 15,
      category: 'on_demand_driver_app',
      ...
      des:
        'The driver app also guides the driver through the entire boarding process.',
    },
    {
      id: 16,
      category: 'on_demand_driver_app',
      ...
      des:
        'The driver app also allows cancelling rides with some statutory fines and actions against them.',
    },
    {
      id: 17,
      category: 'on_demand_driver_app',
      ...
      des:
        'The driver app also offers a gamut of on-the-ride features including GPS based route guidance.',
    },
    {
      id: 18,
      category: 'on_demand_driver_app',
      ...
      des:
        'After the driver is called by the passenger, based upon the distance, rate, pick-up and drop-off location, he can accept or reject the ride.',
    },
    {
      id: 19,
      category: 'on_demand_driver_app',
      ...
      des:
        'The driver app allows the driver to rate the passenger and review the experience while showing the same from passengers. ',
    },
    {
      id: 20,
      category: 'backend',
