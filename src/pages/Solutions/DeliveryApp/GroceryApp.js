...
// Banner
import Development from '../../../assets/images/SOLUTIONS/Delivery App/Grocery-app/Grocery-App-Development.png'
import Services from '../../../assets/images/SOLUTIONS/Delivery App/Grocery-app/Grocery-Delivery-App-Development.png'
import developer from '../../../assets/images/SOLUTIONS/Delivery App/Grocery-app/Grocery-App-Development-Company.png'
...
const GroceryApp = () => {
  ...
  const GroceryData = [
    ...
    },
    {
      ...
      title: 'Check details',
      des:
        'Customers can easily get the details of the grocery item. They can easily check the grocery store details like cost of the item, shipping details and more.',
    },
    {
      id: 3,
      category: 'user_app',
      ...
      title: 'Order Online',
      des:
        'On a Grocery store app, customers can easily add the product to the cart. They can add up the quantity as per preference and place an order.',
    },
    {
      id: 4,
      category: 'user_app',
      ...
      des:
        'This Grocery store app can allow users to make an online payment using the net banking transfer, COD, Paypal, digital wallets and many other methods.',
    },
    {
      id: 5,
      category: 'user_app',
      ...
      des:
        'Grocery store apps can grant customers to give their honest feedback through ratings and reviews about the services and other factors.',
    },
    {
      id: 6,
      category: 'user_app',
      ...
      title: 'Get cashback',
      des:
        'The customer panel is also consist of some of the additional features like seasonal offers, discounts and cashback options.',
    },
    {
      id: 7,
      category: 'user_app',
      ...
      title: 'Login',
      des:
        'Customers can easily check or browse grocery items based on the available offers and the discount code to take advantage of the discounts.',
    },
    {
      id: 8,
      category: 'user_app',
      ...
      des:
        'The customer app can allow the users of the app to view their order history along with the details for each grocery and item.',
    },
    {
      id: 9,
      category: 'user_app',
      ...
      title: 'Live tracking',
      des:
        'GPS is also integrated into the mobile app. Customers can track the grocery item delivery and can also check the Estimated Time of Arrival(ETA).',
    },
    {
      id: 10,
      category: 'vendor_app',
    ...
    },
    {
      ...
      des:
        'The Vendor panel grants to develop product categories and denominations to help easy search and viewing.',
    },
    {
      id: 13,
      category: 'vendor_app',
    ...
    },
    {
      ...
      des:
        'Vendors can assign the jobs to the drives as well as guide the drivers to deliver the product on time. They can easily do the live tracking of the driver.',
    },
    {
      id: 15,
      category: 'vendor_app',
      ...
      des:
        'Grocery Vendors can easily deal with the orders history, the grocery list of the users as well as can send the offers to the customers.',
    },
    {
      id: 16,
      category: 'vendor_app',
    ...
    },
    {
      ...
      des:
        'Whenever customers can prove the reviews, the grocery store owners can see and respond to them. Feedback can help them to improve the quality of services.',
    },
    {
      id: 18,
      category: 'vendor_app',
    ...
    },
    {
      ...
      des:
        'Drivers can provide their availability time so that the grocery store owners can assign the delivery as per the availability f the driver.',
    },
    {
      id: 21,
      category: 'driver_app',
    ...
    },
    {
      ...
      des:
        'Drivers can get the details of the grocery store address or pick up point and drop location along with the customer’s details. Access to the GPS for easy route access.',
    },
    {
      id: 23,
      category: 'driver_app',
      ...
      des:
        'Due to the GPS integration, the drivers can easily track the route to deliver the services on time and this can be also checked by the admin.',
    },
    {
      id: 24,
      category: 'driver_app',
      ...
      des:
        'In a driver app panel, the driver can also check the customer’s feedback and reviews. This can help them to improve the quality of their services.',
    },
    {
      id: 25,
    ...
    },
    {
      ...
      des:
        'Admin panel can help to easily track all the grocery store owners on the list and list grocery items based on the different categories.',
    },
    {
      id: 30,
      category: 'admin_panel',
      ...
      title: 'Get a customer feedback',
      des:
        'Admin Panel will offer access to different reports corresponding to orders, purchases, users as well as sales.',
    },
  ]
