...
const ServiceProvideData = [
  {
    id: 1,
    images: require("../../../assets/images/SERVICES/Software development/asp-net-dev/what-do/1-8.png"),
    que: "Web Development",
  ...
  {
    id: 2,
    images: require("../../../assets/images/SERVICES/Software development/asp-net-dev/what-do/2-9.png"),
  ...
  {
    id: 3,
    images: require("../../../assets/images/SERVICES/Software development/dotnet-dev/what-do/3-10.png"),
    que: "App Maintenance",
  ...
  {
    id: 4,
    images: require("../../../assets/images/SERVICES/Software development/dotnet-dev/what-do/4-10.png"),
    que: "DNN Migration",
  ...
  {
    id: 5,
    images: require("../../../assets/images/SERVICES/Software development/dotnet-dev/what-do/5-10.png"),
    que: "DNN Upgrades",
  ...
  {
    id: 6,
    images: require("../../../assets/images/SERVICES/Software development/dotnet-dev/what-do/6-10.png"),
...
const IndustriesData = [
  ...
  {
    id: 4,
    images: require("../../../assets/images/SERVICES/Software development/asp-net-dev/why-choose/4-9.png"),
