          ...
          <div className="row">
            <div className="col-sm-12 col-md-12 col-lg-12 col-xl-6 mb-4">
              <div className="common_banner_lft">
                <h2>Mobile App Development Manchester</h2>
                <p>
                  To have a mobile presence with an engaging mobile app is of an
                  irreplaceable necessity for any business brand. In Mobile App
                  Development Manchester equally enjoys top priority from every
                  business irrespective of the sizes and niches. The App Ideas
                  is one of the leading mobile app development companies with a
                  great client base in Manchester that comprises of leading
                  brands as well as startups and small businesses across the
                  niches.
                </p>
                  ...
                  <div className="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 mb-2 ">
                    <div className="banner__boxes">
                      <img
                        ...
                        style={{ width: "25%" }}
                      />
                      <h4>App Development Manchester</h4>
                    </div>
                  </div>
                  <div className="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 mb-2 ">
                    <div className="banner__boxes">
                      <img
                        ...
                        style={{ width: "25%" }}
                      />
                      <h4>App Development Company Manchester</h4>
                    </div>
                  </div>
                  <div className="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 mb-2 ">
                    <div className="banner__boxes">
                      <img
                        ...
                        style={{ width: "25%" }}
                      />
                      <h4>App Developers Manchester</h4>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="col-sm-12 col-md-8 col-lg-8 mb-3">
              <div className="contact__lft">
                <p style={{ textAlign: "left" }}>
                  ...
                  Development Manchester? Do you want to know the ways we can
                  make great value additions to your business processes! Feel
                  free to drop us a message and let us reach you with our story.
                </p>
              </div>
            </div>
