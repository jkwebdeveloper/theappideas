          ...
          <div className="row">
            <div className="col-sm-12 col-md-12 col-lg-12 col-xl-6 mb-4">
              <div className="common_banner_lft">
                <h2>Mobile App Development Adelaide</h2>
                <p>
                  The digital footprint for any business brand is not complete
                  without a mobile app. In the Australian city of Adelaide,
                  mobile app development like in every major city enjoys equal
                  focus and priority in the digital landscape pursued by
                  business brands of different niches. The App Ideas is a
                  leading Mobile App Development Adelaide with a worldwide
                  client base and a solid presence in the city of Adelaide as
                  well.
                </p>
                ...
                <div className="row">
                  <div className="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 mb-2 ">
                    <div className="banner__boxes">
                      <img
                        src={require("../../../assets/images/sitemap/adelaide/Wordpress-Developer.png")}
                        alt="Mobile-App-Development"
                        className="img-fluid"
                        style={{ width: "25%" }}
                      />
                      <h4>Mobile App Development Adelaide</h4>
                    </div>
                  </div>
                  <div className="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 mb-2 ">
                    <div className="banner__boxes">
                      <img
                        src={require("../../../assets/images/sitemap/adelaide/Build-Taxi-App.png")}
                        alt="Mobile-Application-Development"
                        className="img-fluid"
                        style={{ width: "25%" }}
                      />
                      <h4>App Development Company Adelaide</h4>
                    </div>
                  </div>
                  <div className="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 mb-2 ">
                    <div className="banner__boxes">
                      <img
                        src={require("../../../assets/images/sitemap/adelaide/Top-Mobile-Game-App-Developers.webp")}
                        alt="Mobile-Application-Development"
                        className="img-fluid"
                        style={{ width: "25%" }}
                      />
                      <h4>App Developers Adelaide</h4>
                    </div>
                  </div>
                </div>
              </div>
