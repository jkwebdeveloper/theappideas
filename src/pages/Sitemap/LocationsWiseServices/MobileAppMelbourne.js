          ...
          <div className="row">
            <div className="col-sm-12 col-md-12 col-lg-12 col-xl-6 mb-4">
              <div className="common_banner_lft">
                <h2>Mobile App Development Melbourne</h2>
                <p>
                  Mobile apps are regarded to be the prima facie of mobile
                  presence instead of the mobile web. Actually, without mobile
                  apps, the branding of any business stands incomplete. When it
                  comes to mobile app development Melbourne has offers an array
                  of acclaimed developer talents with a solid portfolio of
                  successful apps. The App Ideas as a frontline development
                  company has offered development services to many niche
                  businesses with value-driven custom apps.
                </p>
                  ...
                  <div className="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 mb-2 ">
                    <div className="banner__boxes">
                      <img
                        ...
                        style={{ width: '25%' }}
                      />
                      <h4>Mobile App Development Melbourne</h4>
                    </div>
                  </div>
                  <div className="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 mb-2 ">
                    <div className="banner__boxes">
                      <img
                        ...
                        style={{ width: '25%' }}
                      />
                      <h4>App Development Company Melbourne</h4>
                    </div>
                  </div>
                  <div className="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 mb-2 ">
                    <div className="banner__boxes">
                      <img
                        src={require('../../../assets/images/sitemap/manchester/Top-Mobile-Game-App-Developers.webp')}
                        alt="Mobile-Application-Development"
                        className="img-fluid"
                        style={{ width: '25%' }}
                      />
                      <h4>App Developer Melbourne</h4>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="col-sm-12 col-md-8 col-lg-8 mb-3">
              <div className="contact__lft">
                <p style={{ textAlign: 'left' }}>
                  ...
                  services in Melbourne? We are eager to tell you about how we
                  can make exceptional value additions to your business with our
                  app development service. Just free to drop us a message.
                </p>
              </div>
            </div>
